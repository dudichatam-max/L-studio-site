 ...
 * so /privacy, /terms, /guide, /factory-64, /factory-64/drums, /exclusive, /buy and /buy/success return HTTP 200 with the SPA shell.
 */
...
const targets = [
  ...
  join(publicDir, "exclusive", "index.html"),
