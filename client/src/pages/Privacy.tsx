...
const copy: Record<Language, PrivacyCopy> = {
  he: {
    ...
    scope: "היקף המדיניות",
    scopeTitle: "התחייבות",
    scopeBody: "מדיניות זו חלה על אפליקציית L Studio לאנדרואיד ועל השימוש ביכולות האודיו, ההקלטה, השמירה והייצוא שלה.",
    page: "ON THIS PAGE",
  ...
  en: {
    ...
    scopeBody: "This policy applies to the L Studio Android application and its audio, recording, saving and export capabilities.",
    page: "ON THIS PAGE",
  ...
  ru: {
    ...
    scopeBody: "Эта политика относится к Android-приложению L Studio и его функциям аудио, записи, сохранения и экспорта.",
  ...
  ar: {
    ...
    scope: "نطاق السياسة",
    scopeTitle: "وعد واضح.",
    scopeBody: "تنطبق هذه السياسة على تطبيق L Studio لنظام Android وعلى ميزات الصوت والتسجيل والحفظ والتصدير فيه.",
    page: "في هذه الصفحة",
